   ...
   <body> 
      ...
      <form method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
         <table>
            ...
            <tr>
               <td>Time:</td>
               <td> <input type = "time" name = "course">
...
// echo all the data below the form if form is submitted
if(isset($_POST['submit'])){
    echo "<h2>Your given values are as :</h2>";
    echo "<p>Your name is : <b>$name</b></p>";
    echo "<p> your email address is : <b>$email</b></p>";
    echo "<p>Your class time at : <b>$course</b></p>";
    echo "<p>your class info : <b>$class</b></p>";
    echo "<p>your gender is <b>$gender</b></p>";
    echo "selected subjects are : <br>";      
    // loop through subjects array and print all the subjects
    for($i = 0; $i < count($subject); $i++) {
        echo('<b>'.$subject[$i].'</b><br>');
    }
}
?>